		...
		<form class="form-horizontal" action="" method="POST">
			<div class=" card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" id="judul_informasi" name="judul_informasi" class="form-control" placeholder="Judul" value="<?= set_value('judul_informasi'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" id="ket_informasi" name="ket_informasi" class="form-control" placeholder="Keterangan" value="<?= set_value('ket_informasi'); ?>">
