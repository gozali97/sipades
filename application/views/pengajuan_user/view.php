		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
					$no = 1;
					foreach ($lihatsurat as $ls) { ?>


						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $ls['kode_surat']; ?></td>
							<td><?php echo $ls['no_surat']; ?></td>
							<td><?php echo $ls['tanggal']; ?></td>
							<td><?php echo $ls['nik']; ?></td>
							<td><?php echo $ls['nm_surat']; ?></td>
							<td>
								<?php if ($ls['status_surat'] == 'Proses') : ?>
