		...
		<div class="table-responsive">
			<div class="form-group row">
				<div class="ml-1 col-6">
					<a href="<?= base_url('pengajuan_user/meninggal') ?>" class="btn btn-primary">
				...
				<tbody>
					...
					foreach ($suratmati as $sm) { ?>
						...
						<tr>
							...
							<td><?php echo $sm['nm_surat']; ?></td>
							<td><?php echo $sm['ket']; ?></td>
							<td>
								<?php if ($sm['status_surat'] == 'Proses') : ?>
									<a href="#" title="Tindakan" class="btn btn-warning btn-sm">
										<span class="text-white">Proses</span>
									</a>
								<?php elseif ($sm['status_surat'] == 'Ditolak') : ?>
