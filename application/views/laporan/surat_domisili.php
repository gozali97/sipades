		...
		<div class="table-responsive">
			<div class="form-group row">
				<div class="ml-1 col-6">
					<a class="btn btn-danger" href="<?= base_url('laporan/print_surat_domisili'); ?>"><i class="fa fa-print mr-1"></i>Print</a>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					<?php
					$no = 1;
					foreach ($suratdomisili as $sd) { ?>


						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $sd['nm_lengkap']; ?></td>
							<td><?php echo $sd['kode_surat']; ?></td>
							<td><?php echo $sd['no_surat']; ?></td>
							<td><?php echo $sd['tanggal']; ?></td>
