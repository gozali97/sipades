<div class="card card-info mt-3">
	...
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Laporan Data Surat
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<div class="form-group row">
				<div class="ml-1 col-6">
					<a class="btn btn-danger" href="<?= base_url('laporan/print_surat'); ?>"><i class="fa fa-print mr-1"></i>Print</a>
				</div>
				<!-- <div class="col-5">
					<div class="row mr-3">
						<div class="col-md-12">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
					$no = 1;
					foreach ($suratket as $ds) { ?>

						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $ds['nm_lengkap']; ?></td>
							<td><?php echo $ds['nik']; ?></td>
							<td><?php echo $ds['kode_surat']; ?></td>
							<td><?php echo $ds['no_surat']; ?></td>
							<td><?php echo $ds['nm_surat']; ?></td>
